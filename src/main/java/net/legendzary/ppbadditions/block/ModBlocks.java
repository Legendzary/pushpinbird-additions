package net.legendzary.ppbadditions.block;
...
public class ModBlocks {
    ...
    private static Block registerBlock(String name, Block block) {
        ...
        return Registry.register(Registries.BLOCK, Identifier.of(PushpinbirdAdditions.MOD_ID, name), block);
    }

    private static void registerBlockItem(String name, Block block) {
        Registry.register(Registries.ITEM, Identifier.of(PushpinbirdAdditions.MOD_ID, name),
                new BlockItem(block, new Item.Settings()));
    }

    public static void registerModBlocks() {
        PushpinbirdAdditions.LOGGER.info("Registering Mod Blocks for " + PushpinbirdAdditions.MOD_ID);
