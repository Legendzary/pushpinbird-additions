package net.legendzary.ppbadditions.entity.custom;
...
public class PushpinProjectileEntity extends PersistentProjectileEntity {
    ...
    public PushpinProjectileEntity(World world, PlayerEntity player) {
        super(ModEntities.PUSHPIN, player, world, new ItemStack(ModItems.PUSHPIN), null);

    }

    @Override
    protected ItemStack getDefaultItemStack() {
        return new ItemStack(ModItems.PUSHPIN);
    }
